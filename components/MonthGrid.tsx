          ...
          return (
            ...
            */
            <div
              ...
              className={`group/cell relative flex min-h-[120px] cursor-pointer flex-col gap-1 overflow-hidden border-t border-line-soft px-0.5 pb-1.5 pt-1.5 transition hover:bg-canvas lg:min-h-[96px] lg:gap-1 lg:border-t-0 lg:px-2 lg:pb-1.5 lg:pt-2 ${
